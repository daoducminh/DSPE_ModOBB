...
local CharacterSelectScreen = Class(Screen, function(self, profile, cb, no_backbutton, default_character, rog_enabled)
    ...
    if IPHONE_VERSION then
        self.characterquote = self.fixed_root:AddChild(Text(UIFONT, 40))
    else
    ...
    if IPHONE_VERSION then
        ...
        self.characterquote:SetRegionSize( 670, 60 )
    else
    ...
    if IPHONE_VERSION then
        self.characterdetails = self.fixed_root:AddChild(Text(BODYTEXTFONT, 40))
    else
    ...
    if IPHONE_VERSION then
        ...
        self.characterdetails:SetRegionSize( 600, 140 )
    else
...
function CharacterSelectScreen:SetOffset(offset)
	...
	for k = 1,3 do
		...
		if not self.profile:IsCharacterUnlocked(character) then
			print(" ;;; LOCKED Character "..character)
			self.portraits[k]:SetTexture( atlas_silho, character.."_silho.tex")
		else
			print(" ;;; UNLOCKED Character "..character)
