...
if PLATFORM ~= "iOS" and PLATFORM ~= "PS4" and PLATFORM ~= "Android" then
...
if PLATFORM == "iOS" or PLATFORM == "PS4" and PLATFORM ~= "Android" then
	size_descriptions = {
...
for area, items in pairs(GROUP) do
	for name, item in pairs(items.items) do
      ...
      if APP_REGION == "SCEC" then
        item.atlas = "images/customization_shipwrecked_tencent.xml"
      else
