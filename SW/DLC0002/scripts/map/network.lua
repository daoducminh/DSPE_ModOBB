...
function Graph:ConvertGround(map, spawnFN, entities, check_col, fn_alt)

	-- print(";;; GRAPH CONVERT GROUND!")

	local nodes = self:GetNodes(true)
	for k,node in pairs(nodes) do
		node:ConvertGround(map, spawnFN, entities, check_col, fn_alt)
	end 

	-- print(";;; END of GRAPH CONVERT GROUND!")
end
