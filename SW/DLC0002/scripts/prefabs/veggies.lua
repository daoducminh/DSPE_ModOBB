...
VEGGIES =
{
	...
	cave_banana = MakeVegStats(0,	TUNING.CALORIES_SUPERHUGE,	TUNING.HEALING_SUPERHUGE,	TUNING.PERISH_MED, 0,
									TUNING.CALORIES_SUPERHUGE,	TUNING.HEALING_SUPERHUGE,	TUNING.PERISH_FAST, 0),
	...
	berries = MakeVegStats(0,	TUNING.CALORIES_SUPERHUGE,	TUNING.HEALING_SUPERHUGE,	TUNING.PERISH_SUPERSLOW, TUNING.SANITY_HUGE,
								TUNING.CALORIES_SUPERHUGE,	TUNING.HEALING_SUPERHUGE,	TUNING.PERISH_SUPERSLOW, TUNING.SANITY_HUGE),
