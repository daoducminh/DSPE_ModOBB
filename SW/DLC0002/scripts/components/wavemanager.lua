...
local WaveManager = Class(function(self, inst)
	...
	local local_per_sec = 80
	local local_per_sec_shore = 85
	if IOS_DEVICE_PHYSICAL_MEMORY <= 1024 then
		local_per_sec_shore = 12
		local_per_sec = 10
	end

	self.shimmer =
	{
		[GROUND.OCEAN_SHORE] = {per_sec = local_per_sec_shore, spawn_rate = 0, checkfn = checkshore, spawnfn = SpawnWaveShore},
		[GROUND.OCEAN_SHALLOW] = {per_sec = local_per_sec, spawn_rate = 0, checkfn = checkground, spawnfn = SpawnWaveShimmerShallow},
		[GROUND.OCEAN_CORAL] = {per_sec = local_per_sec, spawn_rate = 0, checkfn = checkground, spawnfn = SpawnWaveShimmerShallow},
		[GROUND.OCEAN_CORAL_SHORE] = {per_sec = local_per_sec_shore, spawn_rate = 0, checkfn = checkshore, spawnfn = SpawnWaveShore},
		[GROUND.OCEAN_MEDIUM] = {per_sec = local_per_sec, spawn_rate = 0, checkfn = checkground, spawnfn = SpawnWaveShimmerMedium},
		[GROUND.OCEAN_DEEP] = {per_sec = local_per_sec, spawn_rate = 0, checkfn = checkground, spawnfn = SpawnWaveShimmerDeep},
		[GROUND.OCEAN_SHIPGRAVEYARD] = {per_sec = local_per_sec, spawn_rate = 0, checkfn = checkground, spawnfn = SpawnWaveShimmerDeep},
		[GROUND.FLOOD] = {per_sec = local_per_sec, spawn_rate = 0, checkfn = checkflood, spawnfn = SpawnWaveFlood},
		[GROUND.MANGROVE] = {per_sec = local_per_sec, spawn_rate = 0, checkfn = checkground, spawnfn = SpawnWaveShimmerShallow},
		[GROUND.MANGROVE_SHORE] = {per_sec = local_per_sec_shore, spawn_rate = 0, checkfn = checkshore, spawnfn = SpawnWaveShore},
	}
