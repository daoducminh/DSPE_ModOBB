...
local TUNING_OVERRIDES = 
{
	...
	["grue"] = 	{
								doit = 	function(difficulty)
									if not GetClock() then 
										print "No Clock to set grue!" 
									return end
									local tuning_vars = {
											["never"] =
											{
	                                            GetClock():DisableGrue()
											},
										}
									OverrideTuningVariables(tuning_vars[difficulty])
								end,
	...
	["aggressive_nightmare_creatures"] = 	{
								doit = 	function(difficulty)
									local tuning_vars = {
											["never"] =
											{
	                                            FRIENDLY_NIGHTMARE_CREATURES = true
											},
										}
									OverrideTuningVariables(tuning_vars[difficulty])
								end,
							},
	["sanity_visual_effects"] = 	{
								doit = 	function(difficulty)
									local tuning_vars = {
											["never"] =
											{
	                                            NO_SANITY_VISUAL_EFFECTS = true
											},
										}
									OverrideTuningVariables(tuning_vars[difficulty])
								end,
