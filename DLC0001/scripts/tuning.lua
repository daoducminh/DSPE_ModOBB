...
function Tune(overrides)
	...
	TUNING =
	{
		...
		ARMORDRAGONFLY = wilson_health * 90,
		ARMORDRAGONFLY_ABSORPTION = 1,
		ARMORDRAGONFLY_FIRE_RESIST = 1,

		ARMORBEARGER_SLOW_HUNGER = 0.75,


		ARMOR_WATHGRITHRHAT = wilson_health * 100,
		ARMOR_WATHGRITHRHAT_ABSORPTION = 1,
		...
		WOLFGANG_HUNGER_RATE_MULT_MIGHTY = 2,
	    ...
	    TORNADO_DAMAGE = 7,
	    TORNADO_LIFETIME = 10,
	    TORNADOSTAFF_USES = 1000,

	    FEATHER_FAN_USES = 1000,
