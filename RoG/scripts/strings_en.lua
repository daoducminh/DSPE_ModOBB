...
STRINGS=
{
    NEWOPTIONADDEDHD =
    {
        TITLE ="New HD setting",
        BODY ="A new setting to adjust the texture quality has been added in the options menu. Note that this setting may affect the game performance.",
    },
    CHARACTER_NAMES =
    {
    ...
    CHARACTER_DESCRIPTIONS =
    {
        ...
        pyro = "*Mm mmh mpph mm mmh.\n*Mmph mmh mmph.\n*Mmph mhm mph mmh mpmh!",
    ...
    NAMES =
    {
        ...
        NOSWEATRESURRECTIONSTONE = "Compromising Statue",
        BOARDS = "Boards",
        CUTSTONE = "Cut Stone",
        ...
        BALLOONICORN_LOLLIPOP = "Lollipop",
        PYRO_AXE = "Axtinguisher",
        PYRO_FLARE_GUN = "Flare Gun",      
    ...
    RECIPE_DESC=
    {
        ...
        PYRO_AXE = "Mmhph mm mmh mmp mmphh?",
        PYRO_FLARE_GUN = "Mm mmh mmm, mmph mm mmhp!",
    },
    ...
    MAXWELL_ADVENTUREINTROS =
    {
        LEVEL_1 =
        {
            ...
            THREE = "Hmm. Let's try something a little more challenging,\nshall we?",
...
STRINGS.UI =
{
    ...
    OPTIONS=
    {
        ...
        RECORD_BUTTONS = "Record Buttons",

        HD = "HD Graphics",
        HDPOPUP = "You need to restart the application to see the changes",
    },
    ...
    GAMEMODEMENU = 
    {
        ...
        CLASSIC = "Classic",
        CLASSIC_DESC = "The original uncompromising wilderness survival game.",
        NOSWEAT = "No Sweat",
        NOSWEAT_DESC = "Relax and explore the world.",
    },
    MODSSCREEN = {
        APPLY = "Apply",
        CANCEL = "Cancel",
    ...
    EN_CUSTOMIZATIONSCREEN =
    {
        ...
        PRESETLEVELDESC = {
            ...
            "Take it easy, explore the world.",
    ...
    CUSTOMIZATIONSCREEN =
    {
        ...
        INVALIDDLCCOMBO_TITLE = "Invalid Preset",
        INVALIDDLCCOMBO_BODY = "This Preset can only be used in a Reign Of Giants game.\nPlease select a different Preset.",
        AGGRESSIVE_NIGHTMARE_CREATURES = "Hostile Shadows",
        SANITY_VISUAL_EFFECTS = "Sanity Audio/Visuals",
        DAMAGE = "Damage",
        DEATH_BY_HUNGER = "Starvation",
        DEATH_BY_COLD = "Freezing",
        ...
        CARROT = "Carrots",
        CATCOON = "Catcoons",
        CAVE_ENTRANCE = "Sinkholes",
        CHESS = "Clockworks",
        DAY = "Day Type",
        DECIDUOUSMONSTER = "Deciduous Monsters",
        DEERCLOPS = "Deerclops",
        ...
        LIEFS = "Treeguards",
        LIGHTNING = "Lightning",
        LIGHTNINGGOAT = "Lightning Goats",
        LUREPLANTS = "Lure Plants",
        MANDRAKE = "Mandrakes",
    ...
    NEWGAMESCREEN =
    {
        ...
        ROG_WARNING_BODY = "Don't Starve: Reign of Giants is an expansion geared towards experienced Don't Starve players. Playing with the expansion enabled adds two more seasons, more items and enemies and is a more challenging experience overall.\n\nDo you want to keep Reign of Giants enabled?",
        NOSWEAT_WARNING_TITLE = "Notice - No Sweat Mode Enabled",
        NOSWEAT_WARNING_BODY = "In No Sweat Mode, many game options are tuned down or turned off to make for more relaxing gameplay. Are you sure you want to play this mode?",
        YES = "Yes",
        NO = "No",
    },
    ...
    CONTROLSSCREEN=
    {
        ...
        IOS = {
            TAP_TITLE = "Tap",
            TAP_BODY = "to move, perform\nactions, pick\nobjects, interact\nwith the UI",
            ROT_TITLE = "Rotate",
            ROT_BODY = "to rotate\nthe camera\nand the map",
            HOLD_TITLE = "Hold",
            HOLD_BODY = "to open the\ncontextual menu",
            DRAG_TITLE = "Drag",
            DRAG_BODY = "to move items",
            PINCH_TITLE = "Pinch",
            PINCH_BODY = "to zoom the\ncamera and\nthe map",
        },
    },
...
STRINGS.CHARACTERS =
{
    GENERIC = require "speech_wilson_en",
    WAXWELL = require "speech_maxwell_en",
    WOLFGANG = require "speech_wolfgang_en",
    WX78 = require "speech_wx78_en",
    WILLOW = require "speech_willow_en",
    WENDY = require "speech_wendy_en",
    WOODIE = require "speech_woodie_en",
    WICKERBOTTOM = require "speech_wickerbottom_en",
}

if IsDLCEnabled and IsDLCEnabled(REIGN_OF_GIANTS) then
    STRINGS.CHARACTERS.WATHGRITHR = require "speech_wathgrithr_en"
    STRINGS.CHARACTERS.WEBBER = require "speech_webber_en"
end
