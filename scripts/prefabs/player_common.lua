...
local function onattackother(inst, data)
    ...
    if Profile:IsCharacterUnlocked("pyro") then
        return
    end
    ...
    if (weapon and weapon.components.tool and weapon.components.tool:CanDoAction(ACTIONS.CHOP)) 
    and (target and target.components.health and target.components.health.takingfiredamage) then
        Profile:UnlockCharacter("pyro")    
        Profile.dirty = true
        Profile:Save()
    end
end
