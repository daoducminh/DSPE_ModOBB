...
function SaveIndex:StartSurvivalMode(saveslot, character, customoptions, onsavedcb, dlc, casual)
	self.current_slot = saveslot
...
function SaveIndex:GetIsCasual(slot)
	slot = slot or self.current_slot
 	return self.data.slots[slot].casual
end
