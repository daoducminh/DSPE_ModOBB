...
PYRO_ENABLED = false--BRANCH ~= "release" or (PLATFORM == "WIN32_STEAM" or PLATFORM == "LINUX_STEAM" or PLATFORM == "OSX_STEAM") 
...
--IPHONE_VERSION = TheSim:IsiPhone()
IPHONE_VERSION = true
