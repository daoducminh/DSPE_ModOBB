...
function SaveGame(savename, cb)
    ...
    if PLATFORM == "iOS" then
        local insz, outsz = SavePersistentString(savename, data, ENCODE_SAVES, callback, TheSim:IsiCloudEnabled())
        print ("Saved", savename, outsz)
    else
        local insz, outsz = SavePersistentString(savename, data, ENCODE_SAVES, callback, false)
        print ("Saved", savename, outsz)
    end    
